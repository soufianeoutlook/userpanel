...
ب الحساب المسجل</li>
          ...
          <p className="mb-4">
            ...
            والرسومات والشعارات والصور، هي ملكية لـ ExpressWin أو مرخصة لنا. لا
            يجوز نسخ أو توزيع أو تعديل هذه المواد دون إذن كتابي مسبق.
          </p>

          <h2 className="text-xl font-bold mt-6 mb-3">إخلاء المسؤولية</h2>
          <p className="mb-4">
            يتم توفير خدماتنا "كما هي" و"كما هو متاح" دون أي ضمانات من أي نوع.
            لا نضمن أن خدماتنا ستكون غير منقطعة أو خالية من الأخطاء.
          </p>

          <h2 className="text-xl font-bold mt-6 mb-3">تحديد المسؤولية</h2>
          <p className="mb-4">
            لن نكون مسؤولين عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو خاصة أو
            تبعية ناتجة عن استخدامك لخدماتنا.
          </p>

          <h2 className="text-xl font-bold mt-6 mb-3">التغييرات على الشروط</h2>
          <p className="mb-4">
            نحتفظ بالحق في تعديل هذه الشروط في أي وقت. سنخطرك بأي تغييرات جوهرية
            من خلال إشعار على تطبيقنا أو عبر البريد الإلكتروني.
          </p>
